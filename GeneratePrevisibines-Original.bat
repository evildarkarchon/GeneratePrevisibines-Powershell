...
::
:: Author: PJM V2.91 July 2025 (Add -bsarch and -FO4:<dir> options, supports CKPE .toml, block unuseable modnames, small fixes)

echo ============================================================================
echo Automatic Previsbine Builder V2.91
